...
cellchat_Ctrl = pd.read('../communication_inference/output/burkhardt21_leiden_communications_Ctrl.csv')
cellchat_IFNg = pd.read('../communication_inference/output/burkhardt21_leiden_communications_IFNg.csv')
