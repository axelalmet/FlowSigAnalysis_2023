...
data_directory = '../output/SHH_FOXF1_BMP4/'
...
true_pos_edges = [(1, 2), (2, 3)]
true_neg_edges = [(0, 0), (0, 1), (0, 2), (0, 3),\
                    (1, 0), (1, 1), (1, 3), (2, 0),\
                    (2, 1), (2, 2), (3, 0), (3, 1),\
                    (3, 2), (3, 3)]

ineligible_rows = [0, 0, 0, 2, 3, 3, 3]
ineligible_cols = [1, 2, 3, 1, 0, 1, 2]

# Load the full dataset to get the celltypes
adata_full = sc.read(data_directory + 'adata_shh_foxf1_bmp4.h5ad')
adata = adata_full[:, ['Shh', 'Shh_bound', 'Foxf1', 'Bmp4']]
...
adata_full.write(data_directory + 'adata_shh_foxf1_bmp4.h5ad', compression='gzip')

accuracies_df = pd.DataFrame(accuracies)
accuracies_df.to_csv(data_directory + "accuracies_shh_foxf1_bmp4_nopert.csv")

accuracies_filtered_df = pd.DataFrame(accuracies_filtered)
accuracies_filtered_df.to_csv(data_directory + "accuracies_filtered_shh_foxf1_bmp4_nopert.csv")
...
accuracies_df = pd.DataFrame(accuracies)
accuracies_df.to_csv(data_directory + "accuracies_shh_foxf1_bmp4_nopert_perms.csv")

accuracies_filtered_df = pd.DataFrame(accuracies_filtered)
accuracies_filtered_df.to_csv(data_directory + "accuracies_filtered_shh_foxf1_bmp4_nopert_perms.csv")
...
accuracies_df = pd.DataFrame(accuracies)
accuracies_df.to_csv(data_directory + "accuracies_shh_foxf1_bmp4_pert.csv")

accuracies_filtered_df = pd.DataFrame(accuracies_filtered)
accuracies_filtered_df.to_csv(data_directory + "accuracies_filtered_shh_foxf1_bmp4_pert.csv")
...
accuracies_df = pd.DataFrame(accuracies)
accuracies_df.to_csv(data_directory + "accuracies_shh_foxf1_bmp4_pert_perms.csv")

accuracies_filtered_df = pd.DataFrame(accuracies_filtered)
accuracies_filtered_df.to_csv(data_directory + "accuracies_filtered_shh_foxf1_bmp4_pert_perms.csv")
...
accuracies_df = pd.DataFrame(accuracies)
accuracies_df.to_csv(data_directory + "accuracies_shh_foxf1_bmp4_spatial_nopert.csv")

accuracies_filtered_df = pd.DataFrame(accuracies_filtered)
accuracies_filtered_df.to_csv(data_directory + "accuracies_filtered_shh_foxf1_bmp4_spatial_nopert.csv")
...
accuracies_df = pd.DataFrame(accuracies)
accuracies_df.to_csv(data_directory + "accuracies_shh_foxf1_bmp4_spatial_nopert_perms.csv")

accuracies_filtered_df = pd.DataFrame(accuracies_filtered)
accuracies_filtered_df.to_csv(data_directory + "accuracies_filtered_shh_foxf1_bmp4_spatial_nopert_perms.csv")
...
accuracies_df = pd.DataFrame(accuracies)
accuracies_df.to_csv(data_directory + "accuracies_shh_foxf1_bmp4_spatial_pert.csv")

accuracies_filtered_df = pd.DataFrame(accuracies_filtered)
accuracies_filtered_df.to_csv(data_directory + "accuracies_filtered_shh_foxf1_bmp4_spatial_pert.csv")
...
accuracies_df = pd.DataFrame(accuracies)
accuracies_df.to_csv(data_directory + "accuracies_shh_foxf1_bmp4_spatial_pert_perms.csv")

accuracies_filtered_df = pd.DataFrame(accuracies_filtered)
accuracies_filtered_df.to_csv(data_directory + "accuracies_filtered_shh_foxf1_bmp4_spatial_pert_perms.csv")
